...
1. :star::star: Suppose we know that ![f of n is in big o of g of n](https://latex.codecogs.com/svg.latex?f(n)\in&space;O(g\left(n\right))). Can we conclude that ![f of n is less than or equal to g of n](https://latex.codecogs.com/svg.latex?f(n)\leq&space;g(n)) for small values of ![n](https://latex.codecogs.com/svg.latex?n)? What about for large values?
